...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE deductions SET status = 'Active', updated_at = NOW() WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        error_log('Deduction restoration failed: ' . $conn->error);
        echo json_encode(["success" => false, "message" => "Failed to restore deduction."]);
    }
