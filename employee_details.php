        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><span id="height"><?= $employeeDetails['height(cm)'] ?? 'N/A' ?></span></td>
                </tr>
                <tr>
                    <td><label for="weight">Weight (kg)</label></td>
                    <td><span id="weight"><?= $employeeDetails['weight(kg)'] ?? 'N/A' ?></span></td>
                </tr>
                <tr>
...
<div class="card mb-3">
    <div class="card-header">Employment/Occupational Background</div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table">
                <tr>
...
<!-- Additional Data -->
<div class="card mb-3">
    <div class="card-header">Additional Data</div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table">
                <tr>
        ...
        <div class="table-responsive">
            <table class="table">
                <tr>
                    ...
                    <td><span id="last_name"><?= $employeeDetails['last_name'] ?? 'N/A' ?></span></td>
                </tr>
                <tr>
                    <td><label for="first_name">First Name</label></td>
                    <td><span id="first_name"><?= $employeeDetails['first_name'] ?? 'N/A' ?></span></td>
                </tr>
                <tr>
                    <td><label for="mi">Middle Initial</label></td>
                    <td><span id="mi"><?= $employeeDetails['mi'] ?? 'N/A' ?></span></td>
                </tr>
                <tr>
                    <td><label for="suffix">Suffix</label></td>
                    <td><span id="suffix"><?= $employeeDetails['suffix'] ?? 'N/A' ?></span></td>
                ...
                <tr>
                    ...
                    <td><span id="relationship"><?= $employeeDetails['relationship'] ?? 'N/A' ?></span></td>
                </tr>
                <tr>
                    <td><label for="address">Address</label></td>
                    <td><span id="address"><?= $employeeDetails['address'] ?? 'N/A' ?></span></td>
                </tr>
                <tr>
                    <td><label for="tel_no_home">Tel. No. (Home)</label></td>
                    <td><span id="tel_no_home"><?= $employeeDetails['tel_no_home'] ?? 'N/A' ?></span></td>
                </tr>
                <tr>
                    <td><label for="tel_no_business">Tel. No. (Business)</label></td>
                    <td><span id="tel_no_business"><?= $employeeDetails['tel_no_business'] ?? 'N/A' ?></span></td>
                </tr>
                <tr>
                    <td><label for="mobile_phone_no">Mobile Phone No.</label></td>
                    <td><span id="mobile_phone_no"><?= $employeeDetails['mobile_phone_no'] ?? 'N/A' ?></span></td>
                </tr>
            </table>
        </div>
    </div>
...
<div class="card mb-3">
    <div class="card-header">List of Organizations Been Part Of</div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table">
                <tr>
...
>>>>>>> 7fa6d791622899fb4c6a7e700935eb8196156602
        </div>
    </main>
